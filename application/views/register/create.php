...
<!--							<th class="required">Quantity</th>-->
						...
						<tbody id="docParticulars">
							<tr class="particularsRow">
								...
								<td>
									<fieldset><input type="text" name="particulars[]" value="<?php echo set_value('particulars[]'); ?>" /></fieldset>
								</td>
								<td>
								...
								<td>
									<fieldset><input type="text" style="width:200px;" name="tag[]" value="<?php echo set_value('tag[]'); ?>" /></fieldset>
								</td>
								<td>
