		...
		<div id="filters">
		    <div class="module_content" >
				<form id="frmFilterClient" method="post" action="<?php echo base_url(); ?>index.php/register/filter">
	                ...
	                <fieldset>
	                    <label>Type</label>
	                    <input type="radio" name="type" value="all" <?php if ($filter_type_id == 'all') { ?>checked<?php } ?> onclick="filterByType('all')"/> All
	                    <input type="radio" name="type" value="tds" <?php if ($filter_type_id == 'tds') { ?>checked<?php } ?> onclick="filterByType('tds')" /> TDS
