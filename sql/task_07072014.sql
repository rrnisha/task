...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 08, 2014 at 10:52 AM
...
(666, 'Mr', 'Rishi', 'individual', '9876543210', '', '', '', '', '2014-06-05', 'rrengasa1512@gmail.com', 'Chennai a', 'SDFOU2338B', '', 'G1021', 'F1021', '2014-05-29 23:23:44', '2014-06-08 14:15:30', 'active');
...
--
-- Table structure for table `inward_invoice_sequence`
--

CREATE TABLE IF NOT EXISTS `inward_invoice_sequence` (
...
--
-- Table structure for table `outward_invoice_sequence`
--

CREATE TABLE IF NOT EXISTS `outward_invoice_sequence` (
  `inv_no` int(11) NOT NULL AUTO_INCREMENT,
  `create_date` date NOT NULL,
  `session_id` varchar(100) NOT NULL,
  PRIMARY KEY (`inv_no`)
